...
hardware/
  ...
  sheets/usb3-hub.kicad_sch      # USB5744 + crystal (2 instances, one per CM5 USB 3 port)
  ...
  sheets/m2-nvme.kicad_sch       # M.2 M-key bay 5 on PCIe Gen3 x1, 3V3_M2 buck + load switch (C15)
  brain-drain.kicad_pcb
  lib/                           # project symbols/footprints (USB5744, ASM1153E, DF40, SATA 22, M.2)
...
All blocking decisions are closed (C11–C15). Choose the 12 V brick and record its DIN pin assignment here before layout.
