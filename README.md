...
|---|---|---|
| [`hardware/`](hardware/README.md) | KiCad 9 carrier board, 136 × 100 mm: CM5 wireless, 2× USB5744 hubs, 4× ASM1153E, per-bay power switching, M.2 | schematic 0 ERC errors; v2 outline placed, 81 % of connections autorouted (all signal nets, most plane pins), differential pairs and the last congested supply pins remain (see STATUS R4/R22, D7); SATA footprint pending a drawing |
