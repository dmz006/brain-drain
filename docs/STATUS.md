...
| R16 | (closed 2026-09-23) routing rerun on the v2 outline: 75/75 signal nets routed; the net classes now live in the project file and survive `gen_sch.py` | — | pitfall recorded in USAGE: a DSN without the project's classes carries a 0.2 mm clearance and routes nothing |
